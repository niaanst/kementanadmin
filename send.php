...
$nama_pengirim = 'nia irwanti nasution'; // Isikan dengan nama pengirim
...
$mail->Password = 'sdqcsaujchiyutdz'; // Isikan dengan Password email pengirim
$mail->Port = 465;
$mail->SMTPAuth = true;
$mail->SMTPSecure = 'ssl';
...
if(empty($attachment)){ // Jika tanpa attachment
    ...
    if($send){ // Jika Email berhasil dikirim
        echo "<h1>Email berhasil dikirim</h1><br /><a href='widgets.php'>Kembali ke Form</a>";
    }else{ // Jika Email gagal dikirim
        echo "<h1>Email gagal dikirim</h1><br /><a href='formemail.php'>Kembali ke Form</a>";
    ...
    if($size <= 25000000){ // Jika ukuran file <= 25 MB (25.000.000 bytes)
        ...
        $send = $mail->send();
        if($send){ // Jika Email berhasil dikirim
            echo "<h1>Email berhasil dikirim</h1><br /><a href='formemail.php'>Kembali ke Form</a>";
        }else{ // Jika Email gagal dikirim
            echo "<h1>Email gagal dikirim</h1><br /><a href='formemail.php'>Kembali ke Form</a>";
            // echo '<h1>ERROR<br /><small>Error while sending email: '.$mail->getError().'</small></h1>'; // Aktifkan untuk mengetahui error message
        }
    }else{ // Jika Ukuran file lebih dari 25 MB
        echo "<h1>Ukuran file attachment maksimal 25 MB</h1><br /><a href='formemail.php'>Kembali ke Form</a>";
    }
}
