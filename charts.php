...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="charts.php"><em class="fa fa-bar-chart">&nbsp;</em>Buku Tamu</a></li>
		...
		<div class="panel-body">
			<div class="table-responsive">
				...
				<p> data buku tamu </p>
					...
					<tbody>
						<?php 
							$sql = $koneksi->query("select * from bukutamu");
						...
						<tr>
							<td><?php echo $data['kodepengunjung']; ?></td>
							<td><?php echo $data['nama']; ?></td>
							<td><?php echo $data['tanggal']; ?></td>
							<td><?php echo $data['email']; ?></td>
							<td><?php echo $data['jenispengunjung']; ?></td>
							<td><?php echo $data['tingkatkepuasan']; ?></td>
							<td><?php echo $data['komentar']; ?></td>
							<td>
								
								<a href= aksi_delete_bt.php class="btn btn-danger" >Hapus</a>
							</td>
						</tr>
