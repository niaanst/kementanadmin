...
<body>
							...
							<li>
								<div class="dropdown-messages-box"><a href="profile.html" class="pull-left">
									...
									<div class="message-body"><small class="pull-right">3 mins ago</small>
										<a href="#"><strong>Nia Irwanti Nasution </strong> commented on <strong>your photo</strong>.</a>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="elements.php"><em class="fa fa-toggle-off">&nbsp;</em>Reservasi Hotel</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Reservasi Penginapan </li>
			</ol>
		</div><!--/.row-->
		
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Reservasi Hotel </h1>
			</div>
		</div><!--/.row-->
		...
		<div class="panel-body">
			<div class="table-responsive">
				...
				<p> data Reservasi Penginapan </p>
					...
					<tbody>
						<?php 
							$sql = $koneksi->query("select * from penginapan");
						...
						<tr>
							<td><?php echo $data['kodereservasi']; ?></td>
