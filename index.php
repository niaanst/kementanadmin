...
<head>
	...
	<![endif]-->
        ...
        <script type = "text/javascript">
            FusionCharts.ready(function(){
                ...
                "dataSource": {
                    ...
                    {"label" :"FIT","value":"7"},
                    {"label" : "GIT","value":"2"},
					{"label" : "Instansi","value":"3"},
					{"label" : "Agen Travel","value":"2"}
	 ...
	 <script type = "text/javascript">
	 $('#tabelkunjungan').convertToFusionCharts({
 swfPath: "Charts/",
 type: "MSColumn3D",
 data: "#tabelkunjungan",
	 ...
	 <script type = "text/javascript">
            FusionCharts.ready(function(){
                ...
                "dataSource": {
                    ...
                    {"label" : "Kurang puas","value":"1"},
					 {"label" : "puas","value":"3"},
					  {"label" : "cukup puas","value":"1"},
					   {"label" : "sangat puas","value":"1"}
				...
				<div class="col-xs-6 col-md-3 col-lg-3 no-padding">
					<div class="panel panel-teal panel-widget border-right">
						<div class="row no-padding"><em class="fa fa-xl fa-shopping-cart color-blue"></em>
							<div class="large">
							 <?php
                       $table = "tabel_reservasikunjungan";
                       $date = date('Y-m-d');
                       $conn = mysqli_connect('localhost','root','','museum');
                       $query = mysqli_query($conn, "SELECT * FROM $table");
                       $count = mysqli_num_rows($query);
                       echo "$count <br/>";
                       $query = mysqli_query($conn, "SELECT * FROM $table WHERE data_masuk = '".$date."'");
                       //$count = mysqli_num_rows($query);
                       //echo "Data hari ini : $count";
                    ?>
					</div>
							<div class="text-muted">Reservasi Kunjungan </div>
						</div>
					</div>
				</div>
				<div class="col-xs-6 col-md-3 col-lg-3 no-padding">
					<div class="panel panel-blue panel-widget border-right">
                       ...
                       //echo "Data hari ini : $count";
                    ?></div>
							<div class="text-muted">Buku Tamu</div>
						</div>
					</div>
				</div>
				<div class="col-xs-6 col-md-3 col-lg-3 no-padding">
			...
			<div class="col-xs-6 col-md-3">
				<div class="panel panel-default">
					<div class="panel-body easypiechart-panel">
						...
						<div class="easypiechart" id="easypiechart-blue" data-percent="92" ><span class="percent">30%</span></div>
					</div>
				</div>
			</div>
			<div class="col-xs-6 col-md-3">
				<div class="panel panel-default">
					<div class="panel-body easypiechart-panel">
						<h4>Comments</h4>
						<div class="easypiechart" id="easypiechart-orange" data-percent="65" ><span class="percent">25%</span></div>
					</div>
				</div>
			</div>
			<div class="col-xs-6 col-md-3">
				<div class="panel panel-default">
					<div class="panel-body easypiechart-panel">
						...
						<div class="easypiechart" id="easypiechart-teal" data-percent="56" ><span class="percent">15%</span></div>
					</div>
				</div>
			</div>
			<div class="col-xs-6 col-md-3">
				<div class="panel panel-default">
					<div class="panel-body easypiechart-panel">
						<h4>Pengunjung</h4>
						<div class="easypiechart" id="easypiechart-red" data-percent="27" ><span class="percent">20%</span></div>
					</div>
				</div>
			</div>
		</div><!--/.row-->
